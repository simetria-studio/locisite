...
@section('content')
    <div class="container mt-5 ">
        <div class="text-center">
            <h3 class="text-uppercase">Mormo</h3>
        </div>
        <div class="row">
                ...
                <div class="homozigosedzou">
                    ...
                    <p class="text-start ">
                        <strong>
                            <span class="text-primary">
                                <small>
                                    Qual o método de diagnóstico do MORMO?​​ <br>
                                </small>
                            </span>
                        </strong>
                        <small>
                            O método utilizado é o de ELISA (imunoensaio enzimático). ​
                        </small>
                    </p>
                    <p class="text-start">
                        <small>
                            <strong>
                                <span class="text-primary">
                                    Em quanto tempo o exame de MORMO fica pronto?​
                                    <br>
                                </span>
                            </strong>
                            Este exame fica pronto no mesmo dia pois a análise é instantânea.​
                        </small>
                    </p>
                    <p>
                        <small>
                            <strong>
                                <span class="text-primary">
                                    Porque é importante realizar o teste de MORMO?​<br>
                                </span>
                            </strong>
                            ...
                            guia, devem ter exames de Mormo NEGATIVO.
                        </small>
                    </p>
                    <p>
                        <small>
                            <strong>
                                <span class="text-primary">
                                    Qual a amostra biológica e como é feita a coleta de MORMO? <br>
                                </span>
                            </strong>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Coleta do Exame Mormo </h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p>
                        <strong>Nome do Exame:</strong>Mormo <br>
                        <strong>Mnemônico:</strong> MORMO <br>
                    ...
                    <p>
                        ...
                        * Requisição de Exame para Diagnóstico de Mormo, assinadas e carimbadas pelo médico veterinário
                        solicitante.
                    </p>
                    <p>
                        <strong>OBS:
